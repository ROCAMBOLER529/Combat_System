...
const terrain = {
    ...
    width: 3000,
    river_crossing: true, // true = -1
    dice_debuff: 2,
    natural_fortress: 1,
    amphibious: false // true = -3
}
...
function dice(cant, damange, terrain, isDefeder) {
    ...
    // debuff de atacante
    if (!isDefeder) {
        dice = dice + terrain.natural_fortress; // + bajas por fortaleza natural
        if (terrain.river_crossing) {
            dice++; // + bajas por cruzar un rio
        }
    }
